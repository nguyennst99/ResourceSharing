 ...
 * @author nguyennst
 */
public class LeaderRentAction {
    
    private static final Logger logger = Logger.getLogger(LeaderRentAction.class);
    ...
    public String execute() {
        try {
            ...
            logger.error("LeaderRentAction: " + e.getMessage());
        }
        return SUCCESS;
    }
