 ...
 * @author Admin
 */
public class LeaderViewHistoryAction {
    
    private static final Logger logger = Logger.getLogger(LeaderViewHistoryAction.class);
    ...
    public LeaderViewHistoryAction() {
    }
    ...
    public String execute() {
        ...
        try {
            ...
            logger.error("LeaderViewHistoryAction_Naming: " + ex.getMessage());
        } catch (SQLException ex) {
            logger.error("LeaderViewHistoryAction_SQLE: " + ex.getMessage());
        }
        return url;
    }
