 ...
 * @author nguyennst
 */
public class LeaderSearchAction extends ActionSupport {
    
    private static Logger logger = Logger.getLogger(LeaderSearchAction.class);
    ...
    public void validate() {
        try {
            ...
            logger.error("LeaderSearchAction: " + e.getMessage());
        }
    }
    
    public LeaderSearchAction() {
    }
    ...
    private List<TblResourceDTO> listLeader;
    ...
    public String execute() {
        ...
        try {
            ...
            listLeader = rsDAO.getListResource(nameS, categoryIDS, rentalDate, returnDate, offset, numberRecord);
            for (TblResourceDTO dto : listLeader) {
                String categoryName = cateDAO.findCategoryNameByID(dto.getCategoryID());
                dto.setCategoryName(categoryName);
            }
        } catch (NamingException ex) {
            logger.error("LeaderSearchAction_Naming: " + ex.getMessage());
        } catch (SQLException ex) {
            logger.error("LeaderSearchAction_SQLE: " + ex.getMessage());
        }
        return url;
    }
    ...
    /**
     * @return the listLeader
     */
    public List<TblResourceDTO> getListLeader() {
        return listLeader;
    }

    /**
     * @param listLeader the listLeader to set
     */
    public void setListLeader(List<TblResourceDTO> listLeader) {
