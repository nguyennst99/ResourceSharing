 ...
 * @author Admin
 */
public class LeaderSearchHistoryAction {
    
    private static final Logger logger = Logger.getLogger(LeaderSearchHistoryAction.class);
    ...
    public LeaderSearchHistoryAction() {
    }
    ...
    public String execute() {
        ...
        try {
            ...
            logger.error("LeaderSearchHistoryAction_Naming: " + ex.getMessage());
        } catch (SQLException ex) {
            logger.error("LeaderSearchHistoryAction_SQLE: " + ex.getMessage());
        } 
        return url;
    }
