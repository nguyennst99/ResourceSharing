 ...
 * @author nguyennst
 */
public class LeaderConfirmAction {
    
    private static final Logger logger = Logger.getLogger(LeaderConfirmAction.class);

    private static final String SUCCESS = "success";
    private static final String FAIL = "fail";
    
    public LeaderConfirmAction() {
    }
    ...
    public String execute() {
        ...
        try {
            ...
            logger.error("LeaderConfirmAction_SQLE: " + ex.getMessage());
        } catch (NamingException ex) {
            logger.error("LeaderConfirmAction_Naming: " + ex.getMessage());
        }
        return url;
    }
