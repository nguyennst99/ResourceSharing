 ...
 * @author nguyennst
 */
public class EmployeeViewHistoryAction {

    private static final Logger logger = Logger.getLogger(EmployeeViewHistoryAction.class);
    ...
    public EmployeeViewHistoryAction() {
    ...
    public String execute() {
        ...
        try {
            ...
            logger.error("EmployeeViewHistoryAction_Naming: " + ex.getMessage());
        } catch (SQLException ex) {
            logger.error("EmployeeViewHistoryAction_SQLE: " + ex.getMessage());
        }
        return url;
    }
